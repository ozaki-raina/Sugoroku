...
selecticonList = ['img/dice1.png' , 'img/dice2.png'] #アイコンのimageのリスト
...
class StratScreen(Screen_abc):
    ...
    def display(self):
        ...
        #背景画面
        background = pygame.image.load("img/1021023_coin_fall_1-1.jpg")
        ...
        #キャラクターの出力
        leftcharacter = pygame.image.load("img/画像テストウルトラマン.png")             #左のキャラクター
        rightcharacter = pygame.image.load("img/画像テストウルトラマンかぼちゃ.png")    #右のキャラクター
        ...
        #メニューを選択するときのアイコン
        selecticon = pygame.image.load(selecticonList[selectY])
        selecticon = pygame.transform.scale(selecticon, (25,25))
